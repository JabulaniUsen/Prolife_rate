  ...
  return (
    <div className='py-5 lg:px-10 px-5 flex justify-between items-center shadow-lg'>
        ...
        <div className="flex items-center gap-10">
            <div className="border border-gray-400 rounded-full lg:w-[350px] md:w-[200px] hidden p-2 py-1 lg:flex items-center gap-3">
            ...
            <div className="icons flex items-center gap-10">
                ...
                <div className="relative cursor-pointer flex items-center gap-2 hover:bg-[#b6b6b634] transition-all p-1 rounded-lg">
                    <FontAwesomeIcon icon={faUserAlt} className='text-sm p-2 border border-gray-400 rounded-full text-[#242f48]' />
